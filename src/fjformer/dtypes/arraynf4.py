...
def quantize(array: jax.Array):
    ...
    nSB = scaler_1.size // SB
    scaler_blocks = scaler_1.reshape(nSB, SB)
    scaler_absmax = absmax(scaler_1, SB)
...
def dequantize(
    ...
    nSB = quant_scale.size // SB
    quant_scale = quant_scale.reshape(nSB, SB)
